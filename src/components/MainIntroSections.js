...
const MainIntroSections = () => {
    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="home-content">
              <h6  data-aos="fade-right">سلام , من دکتر زهرا صالحی هستم.</h6>  
              <h3  data-aos="fade-down">فوق تخصص پوست، مو و زیبایی</h3> 
              <h6  data-aos="fade-left">به وب سایت من خوش آمدید.</h6>
              <div className="btn">
                <a href="/"  data-aos="fade-up">مشاوره</a> {/* دکمه مشاوره - Consultation button*/}
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="about" className="about">
        <div className="container">
          <div className="row">
           <div className="title">
  <h2  data-aos="fade-down">زیبایی، تخصص ماست</h2> 
  <p  data-aos="fade-up">
    کلینیک زیبایی دکتر زهرا صالحی با شعار «زیبایی، تخصص ماست» به عنوان یکی از مراکز پیشرو در حوزه پوست، مو و زیبایی شناخته می‌شود. این کلینیک تحت نظر دکتر زهرا صالحی، فوق تخصص پوست، مو و زیبایی، با سال‌ها تجربه علمی و عملی در معتبرترین مراکز درمانی جهان، خدماتی نوین و تخصصی را در محیطی آرام و حرفه‌ای ارائه می‌دهد. از درمان‌های پوستی و جوان‌سازی گرفته تا تزریق ژل، بوتاکس، لیزر و مشاوره‌های تخصصی، همه با هدف حفظ سلامت و افزایش زیبایی طبیعی شما انجام می‌شود. در این کلینیک، زیبایی فقط یک هدف نیست، بلکه یک مسیر علمی، ایمن و شخصی‌سازی‌شده برای هر فرد است.
          ...
          <div className="row">
            <div className="about-content">
             ...
             <div className="title">
  <h2  data-aos="fade-right">کلینیک زیبایی دکتر صالحی</h2> 
  <p>
  ...
  <h2  data-aos="fade-left"> دکتر زهرا صالحی </h2> 
  ...
  <div className="info">
    ...
    <div className="info-item"><label>مطب:</label><p>تهران، خیابان مدیسون، پلاک ۱۲، طبقه دوم</p></div> 
                ...
                <div className="social">
                  <ul>
                    <li data-aos="fade-down"><a href="/"><i className="fab fa-instagram"></i></a></li> 
                    <li data-aos="fade-up"><a href="/"><i className="fab fa-twitter"></i></a></li> 
                    <li data-aos="fade-down"><a href="/"><i className="fab fa-facebook"></i></a></li> 
                     <li data-aos="fade-up"><a href="/"><i className="fas fa-hospital"></i></a></li> 
                     <li data-aos="fade-down"><a href="/"><i className="fas fa-clinic-medical"></i></a></li> 
            ...
            {[
              ...
              <div className="service-item" key={index}>
                <div className="icon" style={{ fontSize: "40px" }}>
                  <i className={service.icon} data-aos="fade-right"></i>
                </div>
                <h4 data-aos="fade-left">{service.title}</h4>
                <p data-aos="fade-up">ارائه بهترین خدمات درمانی و زیبایی برای حفظ سلامت و جذابیت پوست.</p>
              </div>
            ))}
          </div>
        </div>
